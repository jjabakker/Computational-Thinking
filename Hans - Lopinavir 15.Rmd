...
cng = which(colnames(Lopinavir) == "Group")
cnp = which(colnames(Lopinavir) == "PREGNANT")
cna = which(colnames(Lopinavir) == "AGE" )

for (i in 1:nrow(Lopinavir)) {
  if (Lopinavir[i, cnp] == "1") {
    if (Lopinavir[i, cna] > 35) {
      Lopinavir[i,cng] = "Pregnant > 35"
    } else {
      Lopinavir[i,cng] = "Pregnant <= 35"
    }
  }
    ...
    if (Lopinavir[i, cna] > 35) {
      Lopinavir[i,cng] = "Not Pregnant > 35"
    } else {
      Lopinavir[i,cng] = "Not Pregnant <= 35"
    }
  }
